...
img2=img.subsample(6)                                        # minimize the image size
...
button=tkinter.Button(f2,text="7",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 7            
button.grid(row=1,column=0,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="8",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 8
button.grid(row=1,column=1,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="9",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 9
...
button=tkinter.Button(f2,text="4",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 4
button.grid(row=2,column=0,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="5",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 5
button.grid(row=2,column=1,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="6",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 6
...
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="1",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 1
button.grid(row=3,column=0,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="2",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 2
button.grid(row=3,column=1,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="3",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 3
...
button=tkinter.Button(f2,text="C",height=1,width=4,fg="black",bg="orange",font=("Arial",10,"bold"))                 # for clear
button.grid(row=4,column=0,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text="0",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for 0
button.grid(row=4,column=1,padx=8,pady=8)
button.bind("<Button-1>",click)
button=tkinter.Button(f2,text=".",height=1,width=4,fg="black",bg="#D3D3D3",font=("Arial",10,"bold"))                # for point/dot
